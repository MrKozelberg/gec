...
ax.set_xlim([1e-4,6])
# ax.set_xscale('log')
ax.plot(data0[:,1], data0[:,0], label = r'$\xi = 0$')
ax.plot(data05[:,1], data05[:,0], label = r'$\xi = 0.5$')
ax.plot(data1[:,1], data1[:,0], label = r'$\xi = 1$')
...
fig.savefig("../conductivity/COND-TEST.svg")
